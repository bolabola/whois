  ...
  <body>
    <div class="form_div">
      ...
      $_SERVER['PHP_SELF']; ?>" method="get">
        <input type="text" class="google_input" maxlength="100" name="domain" value="<?php
        echo $domain; ?>" placeholder="请输入域名" size="30">
        <input class="formBtn" type="submit" value="查询" /></form>
    </div>
    <div class="response">
		<pre><?php
		if ($domain) {
